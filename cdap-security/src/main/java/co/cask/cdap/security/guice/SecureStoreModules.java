    ...
    public T get() {
      ...
      if (fileBacked) {
        throw new IllegalArgumentException("File secure store password is not set. " +
                                             ...
                                             "cdap-security.xml. For more details please refer to " +
                                             "https://wiki.cask.co/display/CE/Using+Secure+Store.");
      }
      if (kmsBacked) {
        throw new IllegalArgumentException("Only file base secure store is supported in InMemory/Standalone mode. " +
                                             ...
                                             "your cdap-security.xml. For more details please refer to " +
                                             "https://wiki.cask.co/display/CE/Using+Secure+Store.");
      }
      return (T) injector.getInstance(DummySecureStore.class);
    }
